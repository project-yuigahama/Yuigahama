...
module.exports = class extends Language {
  constructor (...args) {
    ...
    this.language = {
      ...
      COMMAND_BAN_DESCRIPTION: 'サーバーからメンバーをBANします。',
      COMMAND_BAN_FAIL_POSITION: 'あなたはこのメンバーに対して処理を実行する事が出来ません。',
      COMMAND_BAN_FAIL_BANNABLE: '私は権限の問題でこのメンバーをBANする事が出来ません。ごめんさい',
      COMMAND_BAN_DONE: (name) => `${name} をサーバーからBANしました。`,
      COMMAND_KICK_DESCRIPTION: 'サーバーからメンバーを追放します。',
      COMMAND_KICK_FAIL_POSITION: 'あなたはこのメンバーに対して処理を実行する事が出来ません。',
      COMMAND_KICK_FAIL_KICKABLE: '私は権限の問題でこのメンバーを追放する事が出来ません。ごめんさい',
      COMMAND_KICK_DONE: (name) => `${name} をサーバーから追放しました。`,
      ...
      COMMAND_GUILD_INFO_DESCRIPTION: 'サーバーの情報を確認出来ます。',
      COMMAND_MEMBER_INFO_DESCRIPTION: 'サーバーにいるメンバーの情報を確認出来ます。',
      ...
      COMMAND_IMAGE_FILTER_EXTENDED_HELP: [
        '画像フィルターを使用できるのは、管理者によって承認されたサーバーだけです。',
        '',
        'フィルタリングレベルは 1 から 9 の間で指定できます。',
        'デフォルトではフィルタリングレベル3に設定されています。',
        '',
        '警告: レベルを高めに設定すると強力なフィルターが有効になりますが、反対に誤検出を起こすかもしれません。',
        'あなたのサーバーに適したレベルを設定をしてください。'
      ],
      ...
      COMMAND_IMAGE_FILTER_LEVEL_FAIL: 'フィルタリングレベルを指定して下さい。',
      COMMAND_IMAGE_FILTER_LEVEL_DONE: (level) => `フィルタリングレベルを**${level}**に設定しました。`,
      ...
      AUTOROLE_PERMISSION_ERROR: (guildname) => `**${guildname}**でAuto Roleが有効化されていますが\`Manage Roles\`の権限が与えられてないので参加したメンバーに役職を与えることが出来ませんでした。`
    }
  }
